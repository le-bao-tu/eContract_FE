...
@Component({
  selector: 'app-certify-type-import-item',
  templateUrl: './certify-type-import-item.component.html',
  styleUrls: ['./certify-type-import-item.component.less'],
})
export class CertifyTypeImportItemComponent implements OnInit {
  constructor(
  ...
  save(): Subscription {
    ...
    const promise = this.certifyTypeApiService.createMany(data).subscribe(
      (res: any) => {
        this.isLoading = false;
        if (res.code !== 200) {
