export const environment = {
  ...
  BASE_WSO2_API: 'https://sandbox-apim.savis.vn/e-contract-back-end/v1/api/v1/wso2/',
  BASE_WSO2_URL: 'https://sandbox-idp.savis.vn/',
  CLIENT_ID: 'mrfiG3i6mobSClFujdTws_NQih0a',
  BASE_CALLBACK_URL: 'https://dev-econtract.digital-id.vn/confirm',
  BASE_LOGOUT_URL: 'https://dev-econtract.digital-id.vn/logout',

  // econtract-enpoint
  API_URL: 'https://sandbox-apim.savis.vn/e-contract-back-end/v1/',
